    ...
    <section className="section-shell pb-20 pt-14">
      ...
      <div className="mb-12">
        <div className="mb-0 border-b border-gold pb-5">
          <h2 className="font-display text-[28px] font-bold text-paper">
            Projects
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          {resumeProjects.map((project, i) => (
            <article
              key={project.title}
              className="panel-gold card-hover overflow-hidden border-t-0"
            >
              ...
              <div className="p-6 md:p-7">
                ...
                <h3 className="mb-2 font-display text-xl text-paper">
                  {project.title}
                </h3>
      ...
      <div>
        ...
        {resumeExperience.map((item) => (
          ...
          >
            <div>
              <h3 className="mb-1 font-display text-[22px] font-bold text-paper">
                {item.role}
              </h3>
              <div className="mb-3 font-display text-[13px] italic text-gold">
                {item.org}
              </div>
